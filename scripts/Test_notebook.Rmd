...
Synching (autocorrelation)

```{r}
acf(poops_only[poops_only$participant=="Rui","datetime"],
    poops_only[poops_only$participant=="Tiago","datetime"])

x = acf(poops_only[poops_only$participant=="Cabecinha","datetime"],
    poops_only[poops_only$participant=="Escudeiro","datetime"])
```
